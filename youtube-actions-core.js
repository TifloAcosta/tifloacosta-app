(() => {
  ...
  const copy = {
    es: {
      ...
      ineligibleAccount: 'YouTube no permite publicar comentarios con esta cuenta. Comprueba que la cuenta tenga un canal de YouTube activo.',
      youtubeForbidden: 'YouTube ha rechazado la publicación del comentario con esta cuenta.',
      insufficientPermissions: 'La autorización actual de YouTube no permite publicar comentarios. Cierra sesión de YouTube en TifloAcosta y vuelve a iniciar sesión.',
      commentTooLong: 'El comentario es demasiado largo para YouTube.',
      invalidCommentMetadata: 'YouTube ha rechazado los datos necesarios para publicar el comentario.',
      processingFailure: 'YouTube no pudo procesar el comentario.',
      quotaExceeded: 'Se ha alcanzado temporalmente el límite de uso de YouTube para esta función.',
      rateLimited: 'YouTube está limitando temporalmente esta acción. Inténtalo de nuevo más tarde.',
      channelNotFound: 'YouTube no ha encontrado el canal asociado al vídeo.',
    ...
    en: {
      ...
      ineligibleAccount: 'YouTube does not allow this account to publish comments. Check that the account has an active YouTube channel.',
      youtubeForbidden: 'YouTube rejected publishing the comment with this account.',
      insufficientPermissions: 'The current YouTube authorization does not allow comments. Sign out of YouTube in TifloAcosta and sign in again.',
      commentTooLong: 'The comment is too long for YouTube.',
      invalidCommentMetadata: 'YouTube rejected the data required to publish the comment.',
      processingFailure: 'YouTube could not process the comment.',
      quotaExceeded: 'The YouTube usage limit for this feature has temporarily been reached.',
      rateLimited: 'YouTube is temporarily limiting this action. Try again later.',
      channelNotFound: 'YouTube could not find the channel associated with the video.',
